...
test("DEFAULT_MODEL is Opus 4.8 and is in the known list", () => {
...
test("supportsAdaptiveThinking covers the 4.6+/Fable family, omits older/unknown", () => {
  for (const m of ["claude-opus-4-8", "claude-opus-4-7", "claude-opus-4-6", "claude-sonnet-4-6", "claude-fable-5"])
